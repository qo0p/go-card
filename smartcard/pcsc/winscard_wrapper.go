...
func (ww *WinscardWrapper) CardConnect(ctx uintptr, reader string, mode uint32, proto uint32) (
	...
	rv, _, _ := ww.cardConnect.Call(
		...
		uintptr(mode /*SCARD_SHARE_SHARED*/), uintptr(proto /*SCARD_PROTOCOL_ANY*/),
